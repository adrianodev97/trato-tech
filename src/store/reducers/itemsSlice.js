...
import alexaDot4 from '../../assets/items/alexa-dot4.png';
import alexaShow10 from '../../assets/items/alexa-show10.png';
import bluetoothSpeaker from '../../assets/items/bluetooth-speaker.png';
import booksReader from '../../assets/items/books-reader.png';
import chair from '../../assets/items/chair.png';
import console1 from '../../assets/items/console-1.png';
import console2 from '../../assets/items/console-2.png';
import control from '../../assets/items/control.png';
import crystalVolantCape from '../../assets/items/crystal-volant-cape.png';
import folderOrganizer from '../../assets/items/folder-organizer.png';
import game1 from '../../assets/items/game-1.png';
import game2 from '../../assets/items/game-2.png';
import guardaTreco from '../../assets/items/keep-stuff.png';
import leatherVolantCape from '../../assets/items/leather-volant-cape.png';
import miniSystem from '../../assets/items/mini-system.png';
import notebook from '../../assets/items/notebook.png';
import paper from '../../assets/items/paper.png';
import seat from '../../assets/items/seat.png';
import sideOrganizer from '../../assets/items/side-organizer.png';
import soundBox from '../../assets/items/sound-box.png';
import tablet from '../../assets/items/tablet.png';
import tv50 from '../../assets/items/tv-50.png';
import tv60 from '../../assets/items/tv-60.png';
import vehicularSupport from '../../assets/items/vehicular-support.png';
...
const initialState = [{
  ...
  description: 'O Leitor de livros digitais com a maior e melhor resolução - tela Paperwhite de 7" e 300 ppi. Leia como se fosse em paper, sem reflexo, mesmo sob a luz do sol.',
  image: booksReader,
  favorite: false,
  price: 447,
  id: uuid(),
  ...
  description: 'Embarque em uma jornada épica e comovente e lute contra queles que desafiam o destino que anseia por conhecimento para ajudá-lo a entender a profecia e o paper que ele desempenhará. Você deve decidir se será acorrentado pelo medo de repetir seus erros ou se libertar de seu passado para ser o pai que precisa.',
  image: game1,
  favorite: false,
  price: 299.90,
  id: uuid(),
  ...
  description: 'notebook inteligente com calendário, elástico para caneta e divisórias Formato: 215 x 280 mm (lxa) Com 60 folhas pautadas e 20 folhas lisas brancas de 90 gramas que você tira e coloca quando quiser Fabricado com muito cuidado e atenção aos detalhes',
  image: notebook,
  favorite: false,
  price: 285,
  id: uuid(),
